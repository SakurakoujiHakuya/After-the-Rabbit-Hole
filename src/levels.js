...
const levelList = [
  {
    ...
    platforms: [
      { id: 'fall-start', type: 'solid', x: 112, y: 132, w: 136, h: 14 },
      { id: 'fall-ledge-1', type: 'solid', x: 32, y: 292, w: 132, h: 14 },
      { id: 'fall-paper-1', type: 'fragile', x: 210, y: 438, w: 116, h: 14, breakDelay: 450 },
      { id: 'fall-ledge-2', type: 'solid', x: 78, y: 584, w: 150, h: 14 },
      { id: 'fall-paper-2', type: 'fragile', x: 244, y: 732, w: 86, h: 14, breakDelay: 450 },
      { id: 'fall-checkpoint-1', type: 'checkpoint', x: 54, y: 878, w: 174, h: 16 },
      { id: 'fall-ledge-3', type: 'solid', x: 222, y: 1034, w: 112, h: 14 },
      { id: 'fall-paper-3', type: 'fragile', x: 94, y: 1184, w: 104, h: 14, breakDelay: 450 },
      { id: 'fall-ledge-4', type: 'solid', x: 24, y: 1332, w: 126, h: 14 },
      { id: 'fall-safe-ledge', type: 'solid', x: 112, y: 1476, w: 104, h: 14 },
      { id: 'fall-cameo-ledge', type: 'fragile', x: 260, y: 1514, w: 82, h: 14, breakDelay: 520 },
      { id: 'fall-paper-4', type: 'fragile', x: 34, y: 1640, w: 112, h: 14, breakDelay: 450 },
      { id: 'fall-checkpoint-2', type: 'checkpoint', x: 172, y: 1792, w: 164, h: 16 },
      { id: 'fall-ledge-5', type: 'solid', x: 38, y: 1950, w: 128, h: 14 },
      { id: 'fall-paper-5', type: 'fragile', x: 218, y: 2092, w: 108, h: 14, breakDelay: 420 },
      { id: 'fall-finish', type: 'solid', x: 96, y: 2344, w: 168, h: 18 },
    ],
    fallHazards: [
      { id: 'fall-spikes-1', type: 'spikes', x: 92, y: 520, w: 250, h: 22 },
      { id: 'fall-spikes-2', type: 'spikes', x: 18, y: 970, w: 218, h: 22 },
      { id: 'fall-spikes-3', type: 'spikes', x: 128, y: 1390, w: 214, h: 22 },
      { id: 'fall-spikes-4', type: 'spikes', x: 18, y: 1880, w: 216, h: 22 },
      { id: 'fall-spikes-5', type: 'spikes', x: 178, y: 2218, w: 164, h: 22 },
    ],
    walls: [],
  },
  {
  ...
  },
  {
    ...
    zones: [{
      ...
      strength: 0.28,
      maxMagnitude: 1.75,
      enterMessage: '镜中的她晚了一步才转身。过去的方向仍在身后追赶。',
      reenterMessage: '旧方向又从镜雾里跟了上来。',
    }],
    switches: [
  ...
  },
  {
    ...
    goal: {
      ...
      requires: {
        ...
        phases: { 'cheshire-light': 1 },
      },
    },
    next: ['queen-garden'],
    phaseRoute: [
      { target: 'moon-lantern', phase: 0 },
      { target: 'moon-smile', phase: 1 },
      { target: 'sun-lantern', phase: 1 },
      { target: 'sun-smile', phase: 0 },
      { target: 'exit-lantern', phase: 0 },
      { target: 'goal', phase: 1 },
    ],
    inheritances: [
      {
    ...
    items: [
      {
        ...
        y: 450,
        r: 13,
        requiresPhases: { 'cheshire-light': 1 },
      },
      {
        id: 'sun-smile',
        type: 'smile',
    ...
    phases: [
      {
        ...
        wallsByState: [
          [
            { x: 260, y: 400, w: 82, h: 18 },
            { x: 18, y: 200, w: 82, h: 18 },
          ],
          [
            { x: 18, y: 500, w: 82, h: 18 },
            { x: 260, y: 300, w: 82, h: 18 },
          ],
        ],
      },
    ],
    switches: [
      {
        ...
        requiresPhase: 0,
        glyph: '☾',
        phaseOnMessage: '月亮睁开眼，紫色树篱从雾里退开。',
        wrongPhaseMessage: '月亮已经醒着，先去找让太阳接管森林的灯。',
        x: 300,
        y: 560,
        r: 18,
      },
      {
        ...
        requiresPhase: 1,
        glyph: '☀',
        phaseOffMessage: '太阳接管森林，金色道路重新出现。',
        wrongPhaseMessage: '太阳还看不见这盏灯，先让月光照进来。',
        x: 60,
        y: 350,
        r: 18,
      },
      {
        ...
        requiresPhase: 0,
        glyph: '☾',
        phaseOnMessage: '最后一轮月光把出口照成了实物。',
        wrongPhaseMessage: '出口只会在太阳退场以后听见这盏月灯。',
        x: 60,
        y: 150,
        r: 18,
      },
    ...
    movers: [
      { id: 'grin-1', type: 'card', x: 80, y: 390, w: 42, h: 14, axis: 'x', range: 150, speed: 0.0015 },
      { id: 'grin-2', type: 'card', x: 238, y: 188, w: 42, h: 14, axis: 'x', range: -150, speed: 0.0019, phase: 1.4 },
    ],
    zones: [
      {
        id: 'cheshire-veil-lower',
        type: 'mirror',
        effect: 'vanish',
        x: 34,
        y: 420,
      ...
      },
      {
        ...
        w: 292,
        h: 74,
        enterMessage: '你在猫雾中消失了，纸牌只能追逐留下的笑。',
        reenterMessage: '猫雾藏起了你的轮廓。',
      },
    ],
    walls: [
      ...border,
      { x: 100, y: 500, w: 160, h: 18 },
      { x: 18, y: 400, w: 150, h: 18 },
      { x: 192, y: 300, w: 150, h: 18 },
      { x: 100, y: 200, w: 160, h: 18 },
      { x: 18, y: 100, w: 150, h: 18 },
    ],
  },
  {
    id: 'queen-garden',
