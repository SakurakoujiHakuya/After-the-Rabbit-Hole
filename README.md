...
游戏包含纵向下坠、重力迷宫、门牌传送、倒流水岸、荒诞竞赛、胡椒风厨房、大小变化、擦除地图、镜面反转、茶杯传送、槌球弹射、纸牌巡逻、过去倒影与猫雾潜行等玩法。每条完整路线有 20 个章节，并包含两处分支选择。

## 梦境实录

| 过去与现在 | 柴郡猫的雾 |
| --- | --- |
| ![第九章：过去倒影与身份印章](./docs/screenshots/chapter-5-identity.png) | ![第十四章：移动猫雾与纸牌监视](./docs/screenshots/chapter-7-cheshire.png) |
...
- **童话怪诞章节**：没有编号的门廊、倒着流的河岸、会擦掉自己的地图，以及从纸牌缝里漏出的规则。
- **原著意象重组**：渡渡鸟竞赛、公爵夫人厨房、胡椒风与飞盘被改造成重力谜题。
